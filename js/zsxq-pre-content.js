...
(function () {
    ...
    const CONFIG = {
        ...
        targetSelector: 'div.talk-content-container, div.answer-content-container',
    ...
    function wrapContentWithPre() {
        ...
        containers.forEach(container => {
            const targets = container.querySelectorAll(CONFIG.targetSelector);
            targets.forEach(target => {
                if (target.firstElementChild?.tagName === 'PRE'
                    && target.firstElementChild?.dataset.processedBy === CONFIG.processedMark) return;
